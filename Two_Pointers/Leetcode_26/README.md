...
### using slow and fast pointer :  TC = O(N)
- If array is empty, return 0.
- Initialize slow = 0 and traverse the array for fast from 1 to n-1:
    - If nums[fast] != nums[slow] =>  incremant the slow pointer and  store the traversed value to updated slow position
