...
- If sum <= threshold, mid is feasible, store it and search left (smaller divisor)
- else mid is too small,  search right (larger divisor)
- Return the smallest feasible divisor
